...
import type { ProjectInviteMetadata, ProjectInviteAcceptResult } from '@repo/shared';
...
type _AcceptResult = AssertWire<
  WireContract<Awaited<ReturnType<typeof acceptInvite>>, ProjectInviteAcceptResult>
>;
